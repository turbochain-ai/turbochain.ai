module.exports = {
  ...
  solution: {
    ...
    bankName: 'Blockchain + XBRL bank letter and credit platform',
    ...
    creditchain: {
      ...
      allianceMember03: 'Wuhan PansoftOrcale Data Service Co., Ltd.',
    ...
    bank: {
      ...
      content0ne: 'Blockchain + XBRL\'s bank letter verification platform is a domestically controllable and secure blockchain platform with the characteristics of decentralization, information tampering and information security.',
    ...
    bankTitle: 'Bank letter and credit platform based on blockchain + XBRL',
  ...
  news: {
    ...
    itemFive: {
      title: 'Fintech company PansoftOrcale in the Turbochain ecosystem completes the first round of financing!',
      date: '2020-01-08',
      summary: 'On January 5, 2020, Wuhan PansoftOrcale Data Services Co., Ltd. (PansoftOrcale) completed the first round of financing and became the first successful financing company in the TurboChain.ai ecosystem.',
    },
    itemSix: {
      title: 'The fintech company PansoftOrcale in the Turbochain ecosystem has completed the first loan recovery of "Export E-loan".',
      date: '2020-03-17',
      summary: 'On March 16, 2020, Wuhan PansoftOrcale Data Services Co., Ltd. (hereinafter referred to as PansoftOrcale), a financial technology company in the TurboChain.ai ecosystem, invested 500,000 yuan in the first export "E-loan" The loan principal and interest recovery is completed.',
    },
    Export_E_Loan: {
      title: 'The fintech company PansoftOrcale in the Turbochain ecosystem has completed the first loan recovery of "Export E-loan".',
      subtitle: 'Issuer: turbochain  2020-03-17 22:05:32',
      textOne: 'On March 16, 2020, Wuhan PansoftOrcale Data Services Co., Ltd. (hereinafter referred to as PansoftOrcale), a financial technology company in the TurboChain.ai ecosystem, invested 500,000 yuan in the first export "E-loan" The loan principal and interest recovery is completed. Xiangyang Ruizhe Company, as the first deposit of unsecured and unsecured loans, has obtained a loan amount on January 20, lasted a loan period of 55 days, and completed a repayment plan on March 16. The annual interest rate of this loan is 4.64% A total of 3,544.44 yuan of interest was collected.',
      textTwo: 'At the beginning of 2020, as recommended by Xiangyang Free Trade Zone and the Municipal Finance Bureau, Xiangyang Finance and Intelligence Service Alliance, Wuhan PansoftOrcale Data Service Co., Ltd., Xiangyang Huaren Certified Public Accountants, Xiangyang Huijietong Supply Chain Management Co., Ltd. and Xiangyang The Municipal Taxation Bureau of Gaoxin District has worked together to solve the problems of Ruizhe\'s foreign trade business and financing difficulties, and finally enabled Ruizhe to achieve a significant reduction in the logistics cost of a single business. It also standardized the financial and taxation integration data of the enterprise industry to form data recognized by the bank. Assets, to obtain "export E loan" unsecured and unsecured loan services at inclusive interest rate.',
      textThree: '“Export E-loan” is a financial product for export-oriented enterprises created by Wuhan PansoftOrcale Data Service Co., Ltd., which combines the resources of the advantageous units of Xiangyang Finance and Intellectual Alliance, and jointly innovates with Xiangyang Agricultural Bank of China. Through the intelligent financial and tax cloud platform and the integrated foreign trade integrated cloud platform, the financial and tax data of the enterprise industry can be checked, traced, and the value of the data assets of small and micro enterprises formed by multi-dimensional data can be exploded. In order to effectively alleviate the problems of small and micro loan financing difficulties, bank risk control difficulties, and department supervision difficulties.',
      textFour: 'At present, Wuhan PansoftOrcale Data Services Co., Ltd.\'s Xiangyang area has officially resumed work. In the future, it will use its advantages in high-end fiscal and tax services, integrated foreign trade services, and inclusive finance to help small and micro enterprises resume work and resume production.',
      textFive: '',
    },
    PansoftOrcal_Financing: {
      title: 'Fintech company PansoftOrcale in the Turbochain ecosystem completes the first round of financing!',
      subtitle: 'Issuer: turbochain  2020-01-08 20:52:27',
      textOne: 'On January 5, 2020, Wuhan PansoftOrcale Data Services Co., Ltd. (PansoftOrcale) completed the first round of financing and became the first successful financing company in the TurboChain.ai ecosystem. This round of financing was invested by the Para Calf Technology Innovation Fund.',
      textTwo: 'With its mature and practical solutions in the field of blockchain and artificial intelligence, TurboChain cooperates with enterprises, regulators, audit institutions, and the public to build an open, fair, transparent, and credible Internet information service ecosystem.',
      textThree: 'PansoftOrcale was established in March 2017 and is a Fintech technology company. The company uses cutting-edge technologies such as blockchain, XBRL, artificial intelligence, big data and cloud computing to create a cross-industry and cross-system real estate finance and tax data fusion platform to transform corporate production and operation finance and taxation data into transferable, splittable, and financing Value information to form a corporate credit chain and empower small and micro enterprises in high-end fiscal and taxation services, comprehensive foreign trade services, and inclusive finance. At present, the platform has served more than 20,000 small and micro enterprises, and has deposited millions of enterprise data. Changing single information into integrated information that connects value chains, and making credible corporate basic data become one of the small and micro enterprise financing credit standards trusted by financial institutions, is a way to ease the difficult situation of small and micro enterprises financing difficult financing.',
      textFour: 'TurboChain is a startup company in the field of blockchain and artificial intelligence. It is led by the joint laboratory of Shandong University Pulian Software Artificial Intelligence and Blockchain.It focuses on artificial intelligence, big data, the Internet of Things, and blockchain technology. The foundation is to create an open and open source enterprise application service platform to provide open, fair, transparent and credible Internet information services to regulators, audit institutions, and the public. The bank\'s letter of credit chain, corporate credit chain, financial archives chain, message service chain, space-time data chain, bill chain, copyright chain, etc. developed with independent controllable technology have broad application scenarios.',
      textFive: '',
    },
    Sansec: {
      title: 'TurboChain Smart and Sansec reach strategic cooperation framework agreement',
