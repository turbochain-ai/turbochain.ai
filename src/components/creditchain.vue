<template>
    <div class="solution" style="background-color: #003366; color: white;margin: 0 auto; padding: 0px; margin-top: 0px;">
        <div class="introduce">
...
<style  src="./../assets/css/creditchain.css" scoped lang="scss">
    .introduce {
        display: flex;
        height: auto;
        min-height: 100vh;
