<template>
    <div class="news">
        ...
        <div class="content">
            <div class="title">
                <h1 class="content-title">{{$t("news.Sansec.title")}}</h1>
                <h1 class="content-subtitle">{{$t("news.Sansec.subtitle")}}</h1>
            </div>
            <div class="text">
                ...
                <p class="content-text">
                    {{$t("news.Sansec.textTwo")}}
                </p>
                <p class="content-text">
                    {{$t("news.Sansec.textThree")}}
                </p>
                <p class="content-text">
                    {{$t("news.Sansec.textFour")}}
                </p>
